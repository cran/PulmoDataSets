...
vignette: >
  %\VignetteIndexEntry{PulmoDataSets: A Curated Collection of Pulmonary and Respiratory Disease Datasets}
...
## All datasets within PulmoDataSets

```{r PulmoDataSets-datasets,echo = TRUE,message = FALSE,warning = FALSE,results = 'markup'}
